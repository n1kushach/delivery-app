...
const Shimmer = ({ className = '' }: { className?: string }) => (
  <div
    className={`relative overflow-hidden rounded bg-gray-200 before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_1.4s_infinite] before:bg-linear-to-r before:from-transparent before:via-white/60 before:to-transparent dark:bg-slate-700 dark:before:via-slate-500/30 ${className}`}
  />
);
...
const OrdersSkeleton = () => (
  <div className="overflow-x-auto rounded-xl border border-gray-200 shadow-sm dark:border-slate-800 dark:shadow-none">
    <table className="min-w-full border-collapse text-sm">
      <thead className="border-b border-gray-200 bg-gray-50 dark:border-slate-800 dark:bg-slate-900/60">
        <tr>
